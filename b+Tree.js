...
BTreeNode.prototype.remove = function(key) {
  console.log("key " + key);
    if (this.isLeaf()) {
      console.log("Es izq "+this.isLeaf()+" this "+ this);
      ...
      console.log("Es dere");
        ...
        var child;
        console.log("index key " + keyIndex);
        if (keyIndex === (-1)) {
            ...
            console.log("parte que no entiendo ");
...
//hay que cambiar esto que no sea con un for o asi como lo puedo hacer 
BTreeNode.prototype.indexOfKey = function(key) {
  console.log("key count "+this._keyCount);
    for (var i = 0; i < this._keyCount; i++) {
